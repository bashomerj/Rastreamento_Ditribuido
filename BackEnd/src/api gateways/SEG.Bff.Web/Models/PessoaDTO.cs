...
namespace SEG.Bff.Web.Models
{
    ...
    //    public DateTime dtvldcrocre { get; set; }
    //    public int tppgt { get; set; }
    //    public int cditfful { get; set; }
    //    public Nullable<decimal> nremp { get; set; }
    //    public int tpcli { get; set; }
    //    public decimal nrinsiap { get; set; }
    //    public int tpclaisp { get; set; }
    ...
    //    public int stestciv { get; set; }
    //    public int nrdepirf { get; set; }
    ...
    //{
    //    public static string Set(int tipoAgregado)
    //    {
    //        return tipoAgregado switch
    //        {
    //            1 => "titular",
    //            2 => "conjuge",
    //            3 => "filho",
