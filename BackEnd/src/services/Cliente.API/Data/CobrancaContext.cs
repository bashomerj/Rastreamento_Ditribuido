...
{
    public sealed class CobrancaContext : DbContext, IUnitOfWork
    {
        private readonly IMediatorHandler _mediatorHandler;

        public CobrancaContext(DbContextOptions<CobrancaContext> options, IMediatorHandler mediatorHandler)
            : base(options)
        {
        ...
        public DbSet<Cliente.API.Models.Entities.Cliente> Cliente { get; set; }
